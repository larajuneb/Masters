...
p2_sig <- ggplot(data_long, aes(x = Week, y = Value, color = Treatment)) +
  ...
  annotate("text", x = 1, y = 0.165, label = "Treatment 1", vjust = 2, hjust = -0.1, angle = 90, size = 3) +
  annotate("text", x = 5, y = 0.165, label = "Treatment 2", vjust = 2, hjust = -0.1, angle = 90, size = 3) +
  annotate("text", x = 9, y = 0.165, label = "Treatment 3", vjust = 2, hjust = -0.1, angle = 90, size = 3)
