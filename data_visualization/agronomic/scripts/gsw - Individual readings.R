...
# Read the data
data <- read.csv("/home/larajuneb/Masters/Code/Masters/data/salt_stress/excl_dead/gsw - Individual readings.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE)
