...
# Read the data
data <- read.csv("Masters/data/salt_stress/all_incl_dead/ETR - Individual readings.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE, sep = ",")
...
write.csv(right_tailed_results, "Masters/data_visualization/agronomic/test_results/salt_stress/all_incl_dead/ETR_individualReadings_right_tailed_results.csv", row.names = FALSE)

left_tailed_results  <- map_dfr(all_weeks, perform_tests_for_week, direction = "left")
write.csv(left_tailed_results, "Masters/data_visualization/agronomic/test_results/salt_stress/all_incl_dead/ETR_individualReadings_left_tailed_results.csv", row.names = FALSE)
