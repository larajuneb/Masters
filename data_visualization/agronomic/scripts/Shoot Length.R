...
# Read the data
data <- read.csv("Masters/data/salt_stress/excl_outliers/Shoot Length.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE)
rownames(data) <- NULL
data
...
write.csv(right_tailed_results, "Masters/data_visualization/agronomic/test_results/salt_stress/excl_outliers/ShootLength_right_tailed_results.csv", row.names = FALSE)

left_tailed_results  <- map_dfr(all_weeks, perform_tests_for_week, direction = "left")
write.csv(left_tailed_results, "Masters/data_visualization/agronomic/test_results/salt_stress/excl_outliers/ShootLength_left_tailed_results.csv", row.names = FALSE)
