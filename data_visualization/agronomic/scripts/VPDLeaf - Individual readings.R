...
# Read the data
data <- read.csv("/home/larajuneb/Masters/Code/Masters/data/salt_stress/excl_dead/VPDLeaf - Individual readings.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE)
