...
# Read the data
data <- read.csv("Masters/data/salt_stress/excl_outliers/porometer_excl_dead/VPDLeaf - Individual readings.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE, sep = ";")
