...
# Read the data
data <- read.csv("/home/larajuneb/Masters/Code/Masters/data/salt_stress/VPDLeaf - Individual readings.csv", header=TRUE, stringsAsFactors=FALSE, check.names = FALSE)
